...
function orderPost($user)
{
    ...
    // TODO Change the fields to check
    ...
    // TODO Change query to add the novel to the db
    ...
    // TODO delete this part or change it to add a novel_user relation
    foreach ($cart as $item) {
...
// The page is loaded only through a POST
if (isPost()) {
    $ans = orderPost($user);
}

$description = "At least poe-try upload page";
$title = "Upload";
require_once "template/header.php"; ?>

<!-- Upload front-end -->
<!-- TODO This first part is not necessary 
...
-->
    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto my-auto lg:py-0">
        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                <h1 class="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl ext-white">
                    Write your novel or select a file
                </h1>

                <!-- Hide the token inside the page for security -->
                <form id="myForm" class="space-y-4 md:space-y-6" action="" method="POST">
                    ...
                    <div id="first_step" class="p-4 bg-white rounded-lg shadow bg-white rounded-lg shadow">
                        <!-- Other content -->
                        <!-- TODO Here We will add input text field, submit button ecc.. to upload the novel -->
                        <div>
    ...
    <!-- TODO This script should not be necessary, can be deleted 
    <script>
